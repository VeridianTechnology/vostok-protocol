        ...
        ? createPortal(
            <div className="fixed right-4 top-4 z-[80] flex items-center gap-2">
              ...
              <a
                ...
                className="flex items-center rounded-full bg-black px-3 py-2 shadow-[0_4px_24px_rgba(0,0,0,0.5)] opacity-40 transition-opacity duration-300 hover:opacity-100"
              >
